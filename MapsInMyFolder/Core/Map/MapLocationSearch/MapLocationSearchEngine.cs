...
{
    public class MapLocationSearchEngineResult
    {
        private static Dictionary<int, MapLocationSearchEngineResult> SearchResultList = new Dictionary<int, MapLocationSearchEngineResult>();
        ...
        public MapLocationSearchEngineResult(int id = -1, string displayName = "", string latitude = "", string longitude = "", string boundingBox = "")
        {
            if (id != -1)
            {
                Id = id;
        ...
        public static void SetSearchResults(Dictionary<int, MapLocationSearchEngineResult> newResults)
        {
            SearchResultList = newResults;
        }
        public static Dictionary<int, MapLocationSearchEngineResult> GetSearchResults()
        {
            return SearchResultList;
        }

        public static MapLocationSearchEngineResult GetResultById(int id)
        {
            if (SearchResultList.TryGetValue(id, out MapLocationSearchEngineResult result))
            {
                return result;
            }
    ...
    public static class MapLocationSearchEngine
    {
        public static (List<string> ListOfAddresses, Dictionary<int, MapLocationSearchEngineResult> SearchEngineResult) Search(string search, double mapLatitude, double mapLongitude)
        {
            try
            {
                ...
                switch (Settings.search_engine)
                {
                    case SearchEngines.ArcGIS:
                        return MapLocationSearchEngine.ArcGISSearch(encodedSearch, mapLatitude, mapLongitude);
                    case SearchEngines.BingMaps:
                        //Bing Search
                        return MapLocationSearchEngine.BingMapSearch(encodedSearch, mapLatitude, mapLongitude);
                    case SearchEngines.OpenStreetMap:
                        //OSM Search
                        return MapLocationSearchEngine.OpenStreetMapSearch(encodedSearch);
                }
            }
            catch (Exception ex)
            {
            ...
            return (new List<string>(), new Dictionary<int, MapLocationSearchEngineResult>());
        }

        public static (List<string>, Dictionary<int, MapLocationSearchEngineResult>) OpenStreetMapSearch(string encodedSearch)
        {
            //OSM Search
            List<string> returnListOfAddresses = new List<string>();
            Dictionary<int, MapLocationSearchEngineResult> returnSearchEngineResult = new Dictionary<int, MapLocationSearchEngineResult>();
            ...
            using (System.Xml.XmlReader reader = XmlReader.Create(responseStream))
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!string.IsNullOrEmpty(displayAdress))
                    {
                        ...
                        returnSearchEngineResult.Add(idSearch, new MapLocationSearchEngineResult(idSearch, displayAdress, latitude, longitude, boundingBox));
                        idSearch++;
                    }
                }
            }
        ...
        public static (List<string>, Dictionary<int, MapLocationSearchEngineResult>) BingMapSearch(string encodedSearch, double mapLatitude, double mapLongitude)
        {
            //OSM Search
            List<string> returnListOfAddresses = new List<string>();
            Dictionary<int, MapLocationSearchEngineResult> returnSearchEngineResult = new Dictionary<int, MapLocationSearchEngineResult>();
        ...
        public static (List<string>, Dictionary<int, MapLocationSearchEngineResult>) ArcGISSearch(string encodedSearch, double mapLatitude, double mapLongitude)
        {
            List<string> returnListOfAddresses = new List<string>();
            Dictionary<int, MapLocationSearchEngineResult> returnSearchEngineResult = new Dictionary<int, MapLocationSearchEngineResult>();
