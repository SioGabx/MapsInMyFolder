...
namespace MapsInMyFolder.Commun
{
    ...
    {
        public static readonly XMLSettingsParser Settings = new XMLSettingsParser();
        public static readonly XMLCacheParser Cache = new XMLCacheParser();
    }
    ...
    public abstract class XMLParserBase
    {
        ...
        public string Read(string key)
        {
            ...
            XElement KeyElement = doc.Descendants(key.Trim()).FirstOrDefault();
        ...
        public void Write(string key, string value, string description = null)
        {
            ...
            {
                XElement XMLFileDocument = doc.Descendants(Type).FirstOrDefault();
