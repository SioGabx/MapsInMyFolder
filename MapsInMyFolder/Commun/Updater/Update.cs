...
namespace MapsInMyFolder.Commun
{
    ...
    {
        public static Version AssemblyVersion { get; private set; } = Assembly.GetEntryAssembly().GetName().Version;
        public static bool IsUpdateAvailable { get; private set; } = false;
        public static RootObject UpdateRelease { get; private set; } = null;
        public static Asset UpdateFileAsset { get; private set; } = null;
