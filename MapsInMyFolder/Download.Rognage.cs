...
{
    public class Rognage
    {
        public (int X, int Y) NO_decalage;
        public (int X, int Y) SE_decalage;
        public int width;
        public int height;
        public Rognage((int X, int Y) NO_decalage, (int X, int Y) SE_decalage, int width, int height)
        {
            this.width = width;
            this.height = height;
        ...
        public static Rognage GetRognageValue(double NO_Latitude, double NO_Longitude, double SE_Latitude, double SE_Longitude, int zoom, int? tile_width)
        {
            ...
            return new Rognage(NO_decalage, SE_decalage, final_image_width, final_image_height);
        }
    }
}
